                    ...
                    <div class="modal-body" style=" margin-top: 10px; margin-bottom: 50px;">
                        <table class="table table-striped table-bordered table-responsive table-condensed"> 
                            ...
                            <tr>
                                <td>Color</td>
                                <td>
                                    <asp:TextBox CssClass="color" ID="txt_color" AutoPostBack="true" runat="server" class="form-control" OnTextChanged="txt_color_TextChanged"></asp:TextBox>
                    ...
                    <div class="modal-body" style=" margin-top: 10px; margin-bottom: 50px;">
                        <table class="table table-striped table-bordered table-responsive table-condensed">
                            ...
                            <tr>
                                <td>Color</td>
                                <td>
                                    <asp:Label ID="lb_newcolor" runat="server" Width="70px" Height="25px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
