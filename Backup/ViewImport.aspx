<%@ Page Language="C#" MasterPageFile="~/MPAdmin.master" AutoEventWireup="true" CodeFile="ViewImport.aspx.cs" Inherits="ViewImport" Title="Untitled Page" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table style="width: 750px; color: black; margin-left:30px" runat=server id="tb_View">
            ...
            <tr>
                <td align=center>
                    <asp:GridView ID="grv_ListImport" runat="server" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" 
                        onpageindexchanging="grv_ListImport_PageIndexChanging" PageSize="33" 
                        Width="700px" onrowediting="grv_ListImport_RowEditing">
                        <Columns>
                            <asp:BoundField DataField="Id_PhieuNhap" HeaderText="Mã phiếu nhập" />
                            <asp:BoundField DataField="HoTen" HeaderText="Người lập phiếu" />
                            <asp:BoundField DataField="TenNhaCungCap" HeaderText="Nhập từ:" />
