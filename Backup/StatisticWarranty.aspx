<%@ Page Language="C#" MasterPageFile="~/MPAdmin.master" AutoEventWireup="true" CodeFile="StatisticWarranty.aspx.cs" Inherits="StatisticWarranty" Title="Untitled Page" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align=center style="width: 750px; color: black" runat=server>
            <tr>
